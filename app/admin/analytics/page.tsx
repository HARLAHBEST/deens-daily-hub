  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500 pb-20">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        ...
        {/* Period Selector */}
        <div className="flex bg-white dark:bg-[#0f1f35] p-1.5 rounded-2xl border border-slate-200 dark:border-white/10 shadow-sm self-start max-w-full overflow-x-auto no-scrollbar">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        <div className="bg-navy rounded-[32px] md:rounded-[40px] p-8 md:p-10 text-white relative overflow-hidden group shadow-2xl">
          ...
          <div className="relative z-10">
            <h3 className="text-3xl md:text-5xl font-black text-gold font-display tracking-tight tabular-nums mb-2">{formatCurrency(stats.netProfit)}</h3>
        ...
        <div className="bg-white dark:bg-[#0f1f35] p-8 md:p-10 rounded-[32px] md:rounded-[40px] border border-slate-200 dark:border-white/5 shadow-sm relative overflow-hidden">
        ...
        <div className="bg-white dark:bg-[#0f1f35] p-8 md:p-10 rounded-[32px] md:rounded-[40px] border border-slate-200 dark:border-white/5 shadow-sm">
           <div className="flex justify-between items-start mb-8 md:mb-10">
          ...
          <div>
            <h3 className="text-3xl md:text-5xl font-black text-navy dark:text-white font-display tracking-tight tabular-nums mb-2">
              {stats.soldCount} <span className="text-sm md:text-lg font-black text-slate-300 dark:text-white/20 uppercase">Units</span>
            </h3>
